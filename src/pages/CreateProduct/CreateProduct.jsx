...
const CreateProduct = () => {
  ...
  return (
    <div>
        <h5 className="productcreate_title">Create New Product</h5>
      <div className="productinputedit">
        ...
        <div className="upload__section">
          ...
          <Button className="muibtn_reacticons" variant="contained">Create <AiOutlineUpload size={"20px"}/>  </Button>
